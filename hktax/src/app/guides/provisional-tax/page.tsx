    ...
    <main>
        ...
        <Container>
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-warm-700">
              {lang === "zh"
                ? "暫繳稅是香港稅制中最令人混淆的安排之一：稅務局在同一張繳稅通知書上，同時徵收「本年度最終稅款」及「下年度暫繳稅款」。以下說明其運作方式、分期繳付日期，以及可申請緩繳暫繳稅的法定理由。"
        ...
        <Container>
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <article className="card p-6">
              ...
              <dl className="mt-4 space-y-3 text-base leading-7 text-warm-700">
                <div>
              ...
              <p className="mt-3 text-xs leading-5 text-warm-500">
                {lang === "zh"
                  ? "以上比例及月份僅屬一般行政安排；行政安排或有變動，實際日期及金額請以你本人的繳稅通知書為準。"
      ...
      <section className="bg-white py-20 sm:py-24 lg:py-28">
        <Container>
          <div className="max-w-3xl">
            ...
            <div className="mt-4 max-w-[65ch] space-y-4 text-base leading-7 text-warm-700">
              <p>
              {lang === "zh"
                ? `政府每年公布的一次性寬減（本年度為稅款的 ${reductionPercent}，每宗個案上限 ${reductionCap}）一般只適用於「最終評稅」的稅款，並不適用於同一張通知書上的暫繳稅部分。原因是暫繳稅只是對下一年度的預先估算，寬減金額須待下一年度完結、稅務局計出該年度的最終評稅後，才會在該年度的稅款中扣除。換言之，你仍須按通知書列明的暫繳稅金額全數繳付，寬減會在下一次評稅時才反映出來。`
              ...
              <p>
                {lang === "zh"
                  ? "另外要留意：暫繳物業稅一直不在每年寬減的適用範圍之內；薪俸稅、利得稅及個人入息課稅則通常適用，實際範圍請以稅務局當年的公布為準。"
              ...
              <p>
                {lang === "zh"
                  ? "本網站的暫繳稅估算，是以本年度的免稅額及扣除上限計算；稅務局計算正式暫繳稅時會採用下一年度的免稅額，金額或有不同。"
      ...
      <section className="bg-warm-50 py-20 sm:py-24 lg:py-28">
        <Container>
          ...
          <p className="mt-4 max-w-[65ch] text-base leading-7 text-warm-700">
            {lang === "zh"
              ? "如符合下列其中一項法定理由，你可以向稅務局申請緩繳（即暫緩繳付）全部或部分暫繳稅款。以下五項適用於暫繳薪俸稅；暫繳利得稅及暫繳物業稅另有相近但各自不同的理由（例如利潤或租值預計下跌九成以上、停止經營業務或不再擁有物業、擬選擇個人入息課稅等），申請時須按稅款種類填寫相應表格。"
          ...
          <ol className="mt-10 grid gap-4 sm:grid-cols-2">
            {holdoverGrounds.map((ground, index) => (
              <li key={ground.en} className="card flex gap-4 p-5">
                ...
                <p className="text-base leading-7 text-warm-700">{ground[lang]}</p>
              </li>
            ))}
          </ol>

          <div className="card mt-6 max-w-3xl border-teal-100 bg-teal-50 p-5">
            <h3 className={`text-sm font-bold text-teal-800 ${labelTracking}`}>
              {lang === "zh" ? "申請期限" : "Application deadline"}
            </h3>
            <p className="mt-2 text-base leading-7 text-warm-700">
              {lang === "zh"
                ? "申請須於「繳稅日期前 28 天」或「繳稅通知書發出日期後 14 天」兩者中較遲的一天或之前提出。此為一般規則；行政安排或有變動，實際期限請以你本人通知書上列明的日期及稅務局最新指引為準。"
      ...
      <section className="bg-white py-20 sm:py-24 lg:py-28">
        <Container>
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-[65ch] text-base leading-7 text-warm-700">
              {lang === "zh"
                ? "在「報稅精靈」及「快速計算機」的結果頁面中，我們會分開列出（a）本年度最終稅款、（b）估算暫繳稅款，最後加總為與繳稅通知書相若的總額，方便你核對。所有金額均按你在頁首選擇的課稅年度，套用該年度已核實的參數即時計算，並非預先寫入的固定數字。"
      ...
      <section className="bg-warm-50 py-14 sm:py-16">
        <Container>
          <p className="max-w-3xl text-xs leading-6 text-warm-600">
            {lang === "zh"
              ? "本頁內容僅供一般教育及參考用途，並非稅務意見；本網站與稅務局並無從屬關係。暫繳稅的分期比例、繳款日期及緩繳申請期限，均可能因個別情況或行政安排而有所不同，實際安排請以你本人的評稅通知書及稅務局最新公布為準；如有疑問，建議諮詢執業會計師或稅務顧問。"
