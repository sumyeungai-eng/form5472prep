  ...
  return [
    {
      ...
      content: {
        zh: (
          <>
            <p>
              個人入息課稅（Personal Assessment，簡稱 PA）<strong>並非香港的第四種稅</strong>，
              而是一種選擇性的「合併計稅」方法。你可以選擇將全年的物業應評稅淨值、
              薪俸稅應評稅入息淨額，以及利得稅應評稅利潤（你個人／夫婦分佔的部分）三項合併，
              再按薪俸稅的扣除、免稅額及稅率計算方式（累進稅率與標準稅率取較低者）計出一個總稅款，
              然後與分開繳付三種稅的總和比較，取較低者。
            </p>
            <p>
              關鍵在於「選擇」二字 — 你或你的配偶須在限期內主動向稅務局提出選擇個人入息課稅，
              稅務局不會自動為你套用。如果計算結果顯示個人入息課稅
              反而須繳付更多稅款，你可在限期內撤回選擇。
            </p>
          </>
        ),
        en: (
      ...
      content: {
        zh: (
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li>
              <strong>有業務虧損的人</strong> — 單獨計算利得稅時，虧損只可結轉至日後年度，
              但個人入息課稅可以將虧損即時抵銷你該年度的其他入息（例如薪俸或租金）。
            </li>
            <li>
              <strong>整體入息不高的業主或小型業務經營者</strong> — 物業稅（{pct(propertyTax.rate, "zh")} 單一稅率）
              及利得稅的兩級制較低稅階，都沒有考慮你的個人免稅額。如果你的整體入息不算高，
              將所有入息合併後再套用免稅額及累進稅率，很可能比逐項分開計算更節省稅款。
            </li>
          </ul>
        ),
        en: (
    ...
    },
    {
      ...
      content: {
        zh: (
          <ul className="list-disc space-y-2 pl-5">
            <li>
              由 2018/19 課稅年度起，已婚人士可<strong>個別</strong>選擇個人入息課稅，
              即使配偶在同一課稅年度亦有應課稅入息，也不會因此失去個別選擇的資格。
            </li>
            <li>
              夫婦亦可在雙方同意下<strong>共同</strong>選擇個人入息課稅，將雙方所有入息
              合併評稅，並使用已婚人士免稅額；最終應繳稅款會按雙方各自的入息比例攤分。
            </li>
            <li>
              如個別及共同選擇均符合資格，應比較兩者的實際稅款；本網站的優化器會自動逐一計算。
            </li>
          </ul>
        ),
        en: (
    ...
    },
    {
      ...
      content: {
        zh: (
          <p>
            是否應該選擇個人入息課稅，往往要逐個情境試算才知道哪個方案稅款最低 — 本網站的報稅精靈及結果頁面，
            會自動列出你（及配偶，如適用）所有合法可行的組合：分開評稅、薪俸稅合併評稅、
            個別選擇個人入息課稅、夫婦共同選擇個人入息課稅，逐一計出總稅款，
            再選出總稅款最低的方案，並以淺白文字解釋為何選擇該方案（例如「因為你出租單位的按揭利息
            及業務虧損可在個人入息課稅下扣除」）。你只須輸入資料一次，毋須自行逐個情境手動計算。
          </p>
        ),
        en: (
          <p>
        ...
        <Container>
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-warm-700">
              {lang === "zh"
                ? "「個人入息課稅」是香港稅制中最容易被誤解的一環 — 很多人以為它是第四種獨立的稅項，其實它只是一種選擇性的合併計稅方法。本指南講解它的運作原理、哪些人可以受惠、夫婦的選擇規則，以及為何值得逐一試算。"
