...
const glossaryEntries: GlossaryEntry[] = [
  {
    ...
    zh: "薪俸稅",
    en: "Salaries Tax",
    defZh: "就源自香港的受僱工作、董事職位及退休金入息徵收的稅項。",
  ...
  },
  {
    ...
    defZh: "應評稅入息淨額再扣除免稅額後的餘額，是計算累進稅率稅款的基礎。",
  ...
  },
  {
    ...
    zh: "標準稅率",
    en: "Standard Rate",
    defZh: "以應評稅入息淨額（未扣免稅額）為基礎、按劃一（兩級）稅率計算的另一種課稅方式；稅務局會與累進稅率的結果比較，取較低者為應繳稅款。",
  ...
  },
  {
    ...
    zh: "寬減",
    en: "Tax Reduction",
    defZh: "政府在財政預算案中公布的一次性稅款寬減百分比及上限，須每年經立法程序通過後才生效，適用範圍及金額每年可能不同。",
  ...
  },
  {
    ...
    zh: "暫繳稅",
    en: "Provisional Tax",
    defZh: "稅務局按上一年度的入息或利潤水平估算，並要求納稅人就本課稅年度預先繳付的稅款；其後會在下一次評稅時用以抵繳實際稅款。",
  ...
  },
  {
    ...
    defZh: "稅務局發出的正式文件，列明應課稅入息、稅款及繳款日期；其發出日期是計算反對期限的起點。",
  ...
  },
  {
    ...
    defZh: "香港的課稅年度，由每年 4 月 1 日起至翌年 3 月 31 日止，例如 2025/26 課稅年度即 2025 年 4 月 1 日至 2026 年 3 月 31 日。",
  ...
  },
  {
    ...
    zh: "租值",
    en: "Rental Value",
    defZh: "僱主提供住宿予僱員時，按住宿類型（例如住宅、酒店房間）以入息某個百分比估算的應課稅利益。",
  ...
  },
  {
    ...
    defZh: "物業稅的課稅基礎，即租金收入扣除業主支付的差餉、不能追回的租金，以及法定修葺及支出免稅額後的淨額。",
  ...
  },
  {
    ...
    zh: "差餉",
    en: "Rates",
    defZh: "政府按物業的應課差餉租值徵收的稅項，與物業稅是兩種不同的稅項；如由業主支付，可在計算物業稅時扣減。",
    defEn: "A government charge based on a property's rateable value, separate from Property Tax; if paid by the owner it can be deducted when computing Property Tax."
  },
  {
    id: "repairs-allowance",
    zh: "法定修葺及支出免稅額",
    en: "Statutory Repairs and Outgoings Allowance",
    defZh: "計算物業稅應評稅淨值時，法例容許扣除的固定百分比，用以涵蓋維修及雜項開支，毋須提交實際單據。",
    defEn: "A fixed statutory percentage deducted when computing a property's net assessable value, covering repairs and outgoings without needing actual receipts."
  },
  {
  ...
  },
  {
    ...
    zh: "反對評稅",
    en: "Objection",
    defZh: "納稅人不同意評稅結果時，在指定期限內向稅務局提出的正式反對程序。",
  ...
  },
  {
    ...
    defZh: "稅務局發給個別人士的標準報稅表格，用以申報全年入息、扣除及免稅額，並作出評稅方式的選擇。",
  ...
  },
  {
    ...
    defZh: "自願醫保計劃下的政府認可醫療保險產品；為納稅人及其指明親屬支付的合資格保費可享稅務扣除。",
  ...
  },
  {
    ...
    defZh: "政府認可的延期年金產品；就該保單繳付的合資格年金保費，可與強積金可扣稅自願性供款共用同一扣除上限。",
        ...
        <Container>
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-warm-700">
              {lang === "zh"
                ? "本表收錄本網站使用的所有主要稅務用詞，按中文詞彙排序，每項附有一句中英對照解釋，方便你在對照報稅表及稅務局文件時查閱。"
                : "This table lists every key tax term used on this site, ordered by its Traditional Chinese term, each with a one-line bilingual definition — handy to check against your tax return and IRD documents."}
            </p>
          </div>
      ...
      <section className="bg-white py-14 sm:py-16">
        <Container>
          <p className="max-w-3xl text-xs leading-6 text-warm-600">
            {lang === "zh"
              ? "本頁內容僅供一般教育及參考用途，並非稅務意見；本網站與稅務局並無從屬關係。詞彙解釋只屬簡化說明，正式定義以《稅務條例》及稅務局發布的文件為準；如有疑問，建議諮詢執業會計師或稅務顧問。"
