...
export const LANDING_PAGES: LandingPage[] = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "A truly inactive LLC — no bank account, no money in or out — may not have a reportable transaction. But the bar is low: a single capital contribution to open the bank account counts. If you're unsure, file anyway. A $149 filing is cheaper than even a small percentage risk of the $25,000 penalty.",
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Use our wizard — it asks 12 simple questions and generates the complete package (cover letter, pro forma 1120, Form 5472, Part V supporting statement). Every filing is reviewed by an accountant on our team before we fax it to the IRS Ogden PIN Unit. From $149 (IRS fax delivery included).",
      },
    ],
  ...
  },
  {
    ...
    metaDescription:
      "Filed Form 5472 late or never at all? Catch up under DIIRSP with a Reasonable Cause Statement and request abatement of the $25,000 penalty. Accountant-reviewed filings from $149.",
    ...
    sections: [
      ...
      {
        heading: "What should you do if you've already received a CP-15 notice?",
      ...
      {
        heading: "Will the IRS notice if I don't file?",
  ...
  },
  {
    ...
    metaDescription:
      "Wyoming LLCs owned by non-US persons must file Form 5472 with pro forma Form 1120 by April 15. Full guide to federal + Wyoming state obligations. Accountant-reviewed filings from $149.",
    ...
    sections: [
      ...
      {
        heading: "What is the Wyoming Annual Report, and how does it differ from Form 5472?",
  ...
  },
  {
    ...
    metaDescription:
      "Delaware LLCs with foreign owners must file IRS Form 5472 + pro forma Form 1120 every year. Complete guide for Stripe Atlas + standalone Delaware LLCs. Accountant-reviewed filings from $149.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: "1. Stripe Atlas SaaS founder, foreign, no US customers: file pro forma 1120 + Form 5472. No US tax. Delaware franchise tax $300. Annual total: $449 ($149 for our federal Standard filing + Delaware's $300). IRS fax delivery included.\n\n2. Delaware LLC for ecommerce serving global customers: file Form 5472 + 1120. Sales tax only in states where economic nexus crossed. Total annual federal compliance: $149 with us on Standard, $199 on Express.\n\n3. Delaware LLC with US-based contractors / freelancers: same federal filing, plus possible 1099-NEC for the contractors (separate filing). No US trade or business if contractors are independent and you have no fixed US place of business.\n\n4. Delaware LLC with US-based employees or US warehouse: significantly more complex — likely US trade or business, ECI income, payroll taxes. Consult a CPA, not our service.\n\n5. Multi-year catch-up: a Delaware LLC formed in 2022 with no Form 5472 filed: a 3-year DIIRSP catch-up is $347 on Standard with fax delivery included, covering 2022, 2023, 2024.\n\n6. Delaware LLC dissolved last year: file a final Form 5472 + 1120 for the partial year ending at dissolution. Still required.",
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Federal: $149 with our service on Standard (5-7 business days) or $199 on Express (3 business days), fax delivery included. Add the $300 Delaware franchise tax = $499 total annual compliance. Add Stripe Atlas's one-time $500 formation cost (year 1 only) for full year-1 picture.",
      },
    ],
  ...
  },
  {
    ...
    metaDescription:
      "German residents who own a US LLC (Wyoming, Delaware, or any state) must file IRS Form 5472 + pro forma 1120 every year. What FTIN to use, common scenarios, and accountant-reviewed filing from $149.",
  ...
  },
  {
    ...
    metaDescription:
      "UAE residents who own a US LLC must file IRS Form 5472 + pro forma 1120 every year. What to enter without a personal UAE tax ID, common scenarios, and accountant-reviewed filing from $149.",
  ...
  },
  {
    ...
    metaDescription:
      "Field-by-field instructions for filling out pro forma Form 1120 for a foreign-owned US LLC. Avoid the common mistakes that trigger IRS notices. Accountant-reviewed filings from $149.",
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes. The wizard auto-detects late filings and adds the DIIRSP Reasonable Cause Statement automatically. Pricing: $149 Standard (ready in 5-7 business days) or $199 Express (within 3 business days) for 1 year, fax included — same filing either way. Add $99 per additional past year for multi-year catch-up.",
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "They can, but most US-based CPAs see this filing once or twice in their career and aren't comfortable with it. Expect $400-$800 and 1-2 weeks of back-and-forth. Our service from $149 (IRS fax delivery included) takes 15 minutes and is reviewed by an accountant on our team.",
      },
      {
  ...
  },
  {
    ...
    metaDescription:
      "Stripe Atlas LLCs owned by non-US founders must file IRS Form 5472 every year. Stripe doesn't handle this — we do. 15-minute accountant-reviewed online filing from $149.",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Standard $149 (fax delivery included). IRS fax delivery is included in every plan — no separate fee.",
      },
      {
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    title: "Form 5472 Filing Service — Accountant-Reviewed, From $149",
    metaDescription:
      "Done-for-you Form 5472 + pro forma Form 1120 for foreign-owned US LLCs. Reviewed by a qualified tax accountant, faxed to IRS Ogden, timestamped receipt back. From $149.",
    ...
    sections: [
      ...
      {
        heading: "Pricing",
        body: "• Standard — $149 for one tax year, ready in 5-7 business days.\n• Express — $199 for one tax year, ready within 3 business days. Same filing, same review, same package — you are paying for speed only.\n• Each additional past tax year: +$99, on either tier.\n\nSo on Standard a two-year DIIRSP catch-up is $149 + $99 = $248 and a three-year catch-up is $149 + $198 = $347. On Express the same catch-ups are $298 and $397. Accountant review, the reasonable cause letter, IRS fax delivery, and the transmission receipt are included at every year count — no separate fax fee, no setup fee, no subscription.\n\nYou pay once, per filing. If we fail to submit your filing to the IRS, you get all of it back.",
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "There are two, and they differ only by speed: $149 Standard (ready in 5-7 business days) and $199 Express (ready within 3), plus $99 for each additional past year you're catching up on. Every filing on either tier gets the same accountant review, the same IRS fax delivery, and the same timestamped receipt — Express is not a better filing, just a faster one.",
      },
      {
        q: "How long does the whole thing take?",
        a: "About 15 minutes of your time in the wizard. On our side, a Standard filing is reviewed and faxed to the IRS Ogden PIN Unit within 5-7 business days of your signature; Express is the same package within 3 business days. Either way the timestamped fax receipt comes back to you by email.",
      },
      {
      ...
      },
      {
        ...
        a: "Yes. The wizard covers up to three years directly; beyond that we coordinate the extra DIIRSP years with you by email. Write to support@form5472prep.com with your entity details and the years involved and we'll scope it before you pay. Pricing follows the same rule: $149 Standard or $199 Express for the first year, +$99 per additional past year.",
      },
      {
  ...
  // ────────────────────────────────────────────────────────────────────
  {
    ...
    metaDescription:
      "Launch promotion: $50 off your Form 5472 + pro forma 1120 filing — $149 down to $99. Accountant-reviewed, faxed to IRS Ogden with a timestamped receipt. Express is $50 off too.",
