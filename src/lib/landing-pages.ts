...
export const LANDING_PAGES: LandingPage[] = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes. IRS fax delivery to +1-855-887-7737 is included in every plan — Standard and Rush. There is no separate fax fee. You will receive the timestamped fax transmission receipt as proof of timely filing.",
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Our service is $199–$279 depending on tier and years. The penalty for a single missed year is $25,000 — a fraction of our service price. For multi-year catch-up packages (add $149 per additional past year), the math is even more compelling against ignoring the obligation.",
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "Pricing",
        body: "Both forms together (cover letter, pro forma 1120, Form 5472, Part V supporting statement) for one year:\n\n• 1 tax year: Standard $199 · Rush $279 (fax included)\n• 2 tax years (DIIRSP catch-up): Standard $348 · Rush $428 (fax included)\n• 3 tax years (DIIRSP catch-up): Standard $497 · Rush $577 (fax included)\n\n100% money-back guarantee if we fail to submit your filing to the IRS.",
      },
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes. The wizard auto-detects late filings and adds the DIIRSP Reasonable Cause Statement automatically. Pricing: Standard $199 · Rush $279 for 1 year (fax included). Add $149 per additional past year for multi-year catch-up.",
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "IRS fax delivery is included in every plan — Standard and Rush. After we fax your package, we email you a polished IRS Fax Transmission Receipt PDF that's also stored in your portal for re-download at any time.",
      },
    ],
