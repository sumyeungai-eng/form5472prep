...
export const metadata: Metadata = {
  ...
  description:
    "Done-for-you IRS Form 5472 and pro forma Form 1120 filing for foreign-owned US single-member LLCs. We prepare, you sign, we fax to the IRS Ogden PIN Unit. Flat-rate Form 5472 filing — $99, fax delivery included. 100% money-back guarantee.",
  ...
  openGraph: {
    ...
    description:
      "For foreign-owned US LLCs. We prepare, you sign, we fax to the IRS Ogden PIN Unit. Flat-rate Form 5472 filing — $99, fax delivery included. 100% money-back guarantee.",
    locale: "en_US",
  },
  twitter: {
    ...
    description:
      "Done-for-you Form 5472 filing for foreign-owned US LLCs. Flat-rate Form 5472 filing — $99, fax delivery included. 100% money-back guarantee.",
  },
  robots: {
    index: true,
    follow: true,
