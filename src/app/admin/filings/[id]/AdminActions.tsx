...
export function AdminActions({ filingId, currentStatus, userEmail, hasFaxService, hasSignedPdf, hasGeneratedPdf, hasCustomerSignature }: Props) {
      ...
      <div className="flex flex-wrap gap-2 pt-2 border-t border-slate-100">
        ...
        {hasSignedPdf && (
          <a
            ...
            title="Opens the signed PDF (what will be faxed to the IRS)"
          >
            View signed PDF ↗
          </a>
        )}
