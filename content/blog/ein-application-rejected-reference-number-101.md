---
title: "EIN Application Rejected: Reference Number 101"
description: "Reference 101 stops an online EIN application for IRS review. Diagnose the name or responsible-party issue and submit Form SS-4 correctly."
date: 2026-08-30
updated: 2026-08-30
author: "Form5472 Prep"
tags: ["ein", "reference-number-101", "form-ss-4", "foreign-owned-llc", "ein-rejection"]
draft: false
---
...
| What you saw | Most likely review area | Exact next action |
|---|---|---|
| The online assistant showed reference 101 after accepting the LLC details | Existing or similar business-name record | Complete Form SS-4, attach the state-stamped formation record, and submit it by the correct fax or mail route |
| The online assistant showed reference 101 while using the owner's SSN or ITIN | Responsible-party name and tax-number validation | Compare the name with the owner's IRS record; if correct, call the number on the message or send signed Form SS-4 for review |
| A foreign owner with no SSN or ITIN reached a stop in the online assistant | The applicant used a channel that requires the responsible party's SSN or ITIN | Stop using the online tool; put “foreign” or “N/A” on line 7b and use the international phone, fax or mail route |
| A faxed SS-4 produced a request for formation evidence, or a repeat request failed on the same day | Possible duplicate-name research or the daily responsible-party limit | Send the requested state document once; if the daily limit was reached, wait until another day rather than sending duplicates |
...
For the broader preparation set, use the [EIN application checklist for a foreign-owned LLC](/blog/ein-application-checklist-foreign-owned-llc). Reference 101 is a rescue problem; the checklist covers the records that should exist before any first submission.
...
First, confirm that line 7a identifies the real individual who ultimately owns or controls the LLC and its funds. A registered agent, formation company or mailbox provider is not substituted merely because that person has a US tax number. Read [who is the EIN responsible party](/blog/ein-responsible-party-foreign-owned-llc) before changing the name.
...
A foreign applicant whose principal place of business is outside the United States should normally use the international routes from the beginning. The [IRS online EIN page](https://www.irs.gov/businesses/small-businesses-self-employed/apply-for-an-employer-identification-number-ein-online) says the online tool requires a US principal place of business and the responsible party's SSN or ITIN.
...
For a field-by-field review, see [how to fill out Form SS-4 for a foreign-owned LLC](/blog/how-to-fill-out-form-ss-4-foreign-owned-llc). That guide explains the high-risk lines without repeating the no-SSN basics here.
