...
description: "No US-Vietnam tax treaty is in force, and Vietnamese tax codes became personal ID numbers in 2025. What Vietnam-based LLC owners file on Form 5472."
date: 2026-09-18
updated: 2026-09-18
author: "Form5472 Prep"
tags: ["form-5472", "vietnam", "foreign-owned-llc", "tax-treaty", "ftin"]
draft: false
---
...
No, because there is no US-Vietnam income tax treaty in force. Vietnam does not appear on the IRS's [United States income tax treaties A to Z](https://www.irs.gov/businesses/international-businesses/united-states-income-tax-treaties-a-to-z) list. Under the letter V, the page lists Venezuela and nothing else.

This is where most content for Vietnam-based founders goes wrong. An agreement does exist on paper: the US Treasury publishes the signed [Agreement between the U.S. and Vietnam for the Avoidance of Double Taxation](https://home.treasury.gov/system/files/131/Treaty-Vietnam-7-7-2015.pdf), dated 7 July 2015. It reads like any treaty in force. It is not one. A signed treaty that has not entered into force gives a taxpayer nothing: no article to invoke, no reduced rate, no competent authority to approach. We take no position on why it never took effect, because we cannot source that.
...
The change came from Circular 86/2024/TT-BTC, issued by Vietnam's Ministry of Finance on 23 December 2024. The Government of Vietnam's news service reported that [personal identification numbers replace tax codes](https://en.baochinhphu.vn/id-numbers-to-be-used-as-personal-tax-code-from-july-2025-111241230102120542.htm) for households, business households, individuals and dependents from 1 July 2025, using the 12-digit number issued by the Ministry of Public Security.
...
1. **Prepare the pro forma Form 1120** with **"Foreign-owned U.S. DE"** across the top of page 1. Only the name and address and items B and E are required.
2. **Prepare Form 5472** - Part I for the LLC, Part II for you with your Vietnamese address, tax code and reference ID, Part III for the related party, Part IV for monetary transactions, and a Part V statement itemising contributions and distributions.
3. **Convert VND to US dollars** at a reasonable rate for each transaction date, applied consistently, and state the basis in the Part V statement.
...
6. **Keep the fax receipt.** It is transmission evidence, not IRS acceptance of the return.

The due date for a calendar-year entity is generally 15 April; Form 7004 extends it. See our [deadline guide](/blog/form-5472-deadline-2026).
...
File every outstanding year promptly with a reasonable cause statement, before the IRS writes to you. Each year carries its own exposure. See our [late filing guide](/blog/form-5472-filed-late-never-filed).
...
[File from Vietnam in about 15 minutes](/start), or compare another no-treaty jurisdiction in our [UAE and Dubai guide](/blog/form-5472-uae-dubai-residents-us-llc).
