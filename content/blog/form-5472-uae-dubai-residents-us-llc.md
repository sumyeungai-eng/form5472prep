...
**A UAE resident who owns a US single-member LLC must file Form 5472 with a pro forma Form 1120 each year the LLC had a reportable transaction with them. There is no US-UAE income tax treaty, and because the UAE issues no personal tax identification number, most Dubai-based owners write "None" in the FTIN block and enter a self-assigned reference ID number.**
...
The penalty for not filing is **$25,000 per form, per year** under IRC § 6038A(d), as stated in the [IRS Instructions for Form 5472](https://www.irs.gov/instructions/i5472). A substantially incomplete form counts as a failure to file. If the failure continues more than 90 days after the IRS mails its notice, an additional $25,000 applies **for each 30-day period (or fraction of one) that the failure continues after that 90-day window** — per related party, with no stated cap (IRC §6038A(d)(2)).

## Does the US-UAE tax situation change anything?

**There is [no income tax treaty in force between the United States and the United Arab Emirates](https://www.irs.gov/businesses/international-businesses/united-states-income-tax-treaties-a-to-z).** That single fact has three consequences for a Dubai-based LLC owner.
...
**2. No reduced withholding on US-source passive income.** Without a treaty, US-source FDAP income such as dividends is generally subject to 30% withholding under [IRC §871(a)](https://www.law.cornell.edu/uscode/text/26/871) rather than a treaty-reduced rate. This matters for owners holding US securities personally; it usually does not touch an operating business.
...
Write "None" in the FTIN block and enter a self-assigned reference ID number on line 4b(2) — the UAE issues individuals no personal tax identification number.

Part II of Form 5472 asks for the foreign shareholder's identifying numbers on three lines:

| Part II line | UAE individual owner entry | Notes |
|---|---|---|
| Line 4b(1) | US identifying number only if you already have one | Most UAE residents leave this blank because they have no SSN, ITIN or EIN personally |
| Line 4b(2) | Self-assigned reference ID number | Required when line 4b(1) is blank; use the same alphanumeric ID every year |
| Line 4b(3) | "None" or "N/A" | The FTIN field should not be left blank when no UAE personal tax ID exists |

The UAE has no personal income tax and issues no personal tax identification number to individual residents. UAE Tax Registration Numbers exist for VAT and for corporate tax, but those are issued to businesses or to natural persons in a business capacity, not as a general personal FTIN — and a company's TRN is not your personal FTIN.

Do not use an Emirates ID number as an FTIN — it is an identity document number, not a tax identification number. Do not enter a free-zone company's TRN as your personal FTIN. And do not apply for a US ITIN just to fill this box: the reference ID mechanism exists precisely so that owners in non-taxing jurisdictions can file without one. Details in our [FTIN and reference ID guide](/blog/form-5472-ftin-reference-id-foreign-address) and [do I need an ITIN for Form 5472](/blog/itin-required-form-5472).
...
The UAE introduced a federal corporate tax of **9% on taxable income above AED 375,000**, effective for financial years beginning on or after 1 June 2023 under UAE Federal Decree-Law No. 47 of 2022 and the Ministry of Finance's [corporate-tax threshold guidance](https://mof.gov.ae/en/news/ministry-of-finance-confirms-applicable-taxable-income-threshold-for-corporate-tax-abu-dhabi-uae/). There is still no UAE personal income tax.
...
- **If your US LLC transacts with your UAE free-zone company**, that company is a foreign related party — which means a **second Form 5472** for that party. See [multiple related parties on Form 5472](/blog/multiple-related-parties-form-5472). You file one Form 5472 per related party, and the line 1g count on each reflects the total.
...
1. **Prepare the pro forma Form 1120** — the LLC's name, EIN, US address, formation date and year-end total assets — signed, with **"Foreign-owned U.S. DE"** written across the top of page 1.
2. **Prepare Form 5472** — Part I for the LLC including the line 3 foreign-owned US DE box, Part II for you with your UAE address, "None" or "N/A" in the FTIN block and a reference ID, Part III for the related party, Part IV for listed monetary transactions, and **Part V with an attached statement** itemizing contributions and distributions.
3. **Convert everything to US dollars.** AED amounts must be converted at a reasonable rate for the transaction date, applied consistently. The UAE government's fact sheet states that the AED is pegged to the dollar at [1 USD = AED 3.6725](https://u.ae/en/about-the-uae/fact-sheet), which makes this simpler than for most currencies — but state your basis in the Part V statement.
4. **Fax to 855-887-7737**, or mail to Internal Revenue Service, 1973 Rulon White Blvd, M/S 6112, Attn: PIN Unit, Ogden, UT 84201.
5. **Keep the timestamped fax receipt.** The IRS sends no acknowledgement. That receipt is your only proof of filing.

Worked AED conversion example:

| Transaction | Original amount | Working | USD workpaper amount |
|---|---:|---|---:|
| Owner contribution | AED 3,672.50 | AED 3,672.50 / 3.6725 | USD 1,000 |
| Owner withdrawal | AED 1,836.25 | AED 1,836.25 / 3.6725 | USD 500 |
| Owner-paid expense | USD 240 | Already in USD | USD 240 |
| Total related-party value reviewed |  | USD 1,000 + USD 500 + USD 240 | USD 1,740 |

Deadline: **15 April 2026** for a 2025 calendar-year LLC, or **15 October 2026** if you filed Form 7004 — which a foreign-owned DE must fax to the same Ogden PIN Unit by the regular due date. Full dates in our [deadline guide](/blog/form-5472-deadline-2026).
...
No. The [IRS treaty A-to-Z page](https://www.irs.gov/businesses/international-businesses/united-states-income-tax-treaties-a-to-z) lists no income tax treaty in force between the United States and the United Arab Emirates. UAE residents cannot claim permanent establishment protection or reduced withholding rates, and the effectively connected income analysis is made under US domestic law alone.

### What FTIN do I use on Form 5472 as a UAE resident?

Enter "None" or "N/A" in the FTIN block — the instructions say not to leave it blank — and enter a self-assigned reference ID number on line 4b(2), using the identical reference ID in every year you file.
...
No — they are separate systems. UAE corporate tax is a question for a UAE adviser. US tax depends on whether you have income effectively connected with a US trade or business, which a business run entirely from the UAE usually does not. Form 5472 is required either way.
...
File all outstanding years as soon as possible with a reasonable cause statement, before the IRS contacts you. Each year carries its own $25,000 exposure. See our [late filing guide](/blog/form-5472-filed-late-never-filed).
