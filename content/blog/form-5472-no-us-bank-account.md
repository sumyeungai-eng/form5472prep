---
title: "Form 5472 With No US Bank Account"
description: "A foreign-owned LLC can need Form 5472 without a US bank account. Owner-paid fees, formation costs, and foreign-account transfers may still count."
date: 2026-08-25
updated: 2026-08-25
author: "Form5472 Prep"
tags: ["form-5472", "no-bank-account", "foreign-owned-llc", "dormant-llc"]
draft: false
---
...
The [IRS Instructions for Form 5472](https://www.irs.gov/instructions/i5472) require foreign-owned US disregarded entities to report transactions with their foreign owner and other related parties. Part V includes amounts connected with formation and dissolution, contributions, distributions, and other transactions.
...
A genuinely dormant LLC with no reportable transaction can fall outside the annual Form 5472 requirement. In practice, first-year entities often have at least one formation payment. Our [dormant-LLC guide](/blog/form-5472-dormant-llc-no-income) explains the difference.
...
The IRS [FBAR overview](https://www.irs.gov/businesses/small-businesses-self-employed/report-of-foreign-bank-and-financial-accounts-fbar) confirms that the filing applies to US persons with qualifying foreign financial accounts. It is a different regime from Form 5472.
...
If the LLC has no EIN, use the [EIN guide for foreign owners](/blog/ein-for-foreign-owned-llc-without-ssn) before the filing deadline. Do not put the owner’s foreign tax number in the LLC EIN field.

## What is a defensible zero-activity workpaper?

Use a “six-zero test” and retain the result:

1. **No owner funding** in cash, property, or services.
2. **No owner-paid LLC costs**, including state, agent, mail, software, or organizer fees.
3. **No LLC-to-owner payments** or reimbursements.
4. **No loans** in either direction.
5. **No transactions with another related party.**
6. **No formation, acquisition, disposition, or dissolution value** during the year.
...
1. **Collect personal and foreign-account records.** Search for LLC-related charges and transfers.
2. **Reconcile formation and annual-maintenance invoices.** Identify who actually paid each item.
3. **Build the owner ledger.** Record gross contributions, distributions, loans, reimbursements, and direct vendor payments.
4. **Convert foreign currency to US dollars.** Retain the original amount, rate source, and arithmetic.
5. **Prepare Form 5472 and the pro forma Form 1120.** Attach the Part V statement where required.
6. **Fax or mail the signed package.** A foreign-owned US disregarded entity cannot e-file it.
