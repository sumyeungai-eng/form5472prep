...
If the LLC had owner funding, withdrawals, loans, reimbursements, or another related-party transaction, [start the Form 5472 package](/start) while separately checking whether the owner has a Form 1040-NR obligation.
...
The safest first step is to classify the two obligations separately. [Start the reviewed Form 5472 filing](/start), then have an international tax adviser resolve the owner's Form 1040-NR position where needed.
