...
The [current IRS form](https://www.irs.gov/pub/irs-pdf/f5472.pdf) requires foreign-owned disregarded entities to describe Part V transactions on an attached statement. A clean statement should identify the date, parties, type, amount, currency, conversion method, and business purpose.
...
Reconcile the four buckets to bank statements and the owner’s records. Convert foreign-currency amounts to U.S. dollars using a consistent, documented method. The IRS publishes [yearly average currency exchange rates](https://www.irs.gov/individuals/international-taxpayers/yearly-average-currency-exchange-rates), although a transaction-date rate may be more appropriate for a specific transfer.
...
[Start your filing for $99](/start) if your LLC has owner funding, withdrawals, loans, reimbursements, or other related-party activity.
