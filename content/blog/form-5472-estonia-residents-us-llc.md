...
tags: ["form-5472", "estonia", "e-residency", "foreign-owned-llc", "ftin"]
draft: false
---
...
No. The Estonian Tax and Customs Board states that [in the meaning of Estonian tax law, an e-resident is a non-resident](https://www.emta.ee/en/private-client/foreigner-non-resident/foreigners/e-residents), and that the Estonian digital ID does not grant tax residency. The e-Residency programme's own [responsibilities page](https://www.e-resident.gov.ee/blog/posts/responsibilities-of-e-residents/) says the same thing from the other direction: e-Residency does not affect your personal tax residency.
...
Estonia appears on the [IRS list of United States income tax treaties](https://www.irs.gov/businesses/international-businesses/united-states-income-tax-treaties-a-to-z) with no caution note marking it suspended or terminated; the IRS documents page carries the 1998 treaty.
...
Do not apply for a US ITIN just to fill the box; a reference ID number (up to 50 alphanumeric characters) exists for owners without a US identifying number. See our [FTIN and reference ID guide](/blog/form-5472-ftin-reference-id-foreign-address) and [do I need an ITIN for Form 5472](/blog/itin-required-form-5472).
...
1. **Prepare the pro forma Form 1120** with **"Foreign-owned U.S. DE"** written across the top of page 1. Only the LLC's name and address and items B and E are required.
2. **Prepare Form 5472.** Part II carries your residential address, line 4e country, FTIN entry and any reference ID; attach a statement itemising contributions and distributions.
3. **Convert euros to US dollars** at a reasonable rate for each transaction date, applied consistently, and state your basis in the statement.
...
The regular due date for a calendar-year LLC is generally 15 April. Form 7004 extends it using the special instructions for a foreign-owned DE; full dates are in our [2026 deadline guide](/blog/form-5472-deadline-2026).
...
File every outstanding year, with a reasonable cause statement, before the IRS contacts you. Each year carries its own penalty exposure. See our [late filing guide](/blog/form-5472-filed-late-never-filed).
...
[File your Form 5472 in about 15 minutes](/start).
