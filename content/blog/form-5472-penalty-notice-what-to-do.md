...
**If the IRS assessed a $25,000 Form 5472 penalty, you generally have three options: pay it, request abatement in writing on reasonable cause grounds, or appeal. The penalty under IRC § 6038A(d) is assessed automatically by computer, so a reasonable cause letter you already sent may never have been read. Respond in writing by the date on the notice.**
...
The IRS assesses a $25,000 penalty when a reporting corporation fails to file Form 5472 when due and in the manner prescribed, or files a substantially incomplete form. The rule is in IRC § 6038A(d) and is restated plainly in the [IRS Instructions for Form 5472 (Rev. December 2024)](https://www.irs.gov/instructions/i5472): "A penalty of $25,000 will be assessed on any reporting corporation that fails to file Form 5472 when due and in the manner prescribed."

Four separate failures trigger the same $25,000 charge:

1. **Not filing at all** for a year in which the LLC had a reportable transaction.
2. **Filing late** — even by one day past the due date, including extensions.
...
The [IRS Administrative penalty relief page](https://www.irs.gov/payments/administrative-penalty-relief) — reviewed 14 July 2026 — lists FTA as available for:
...
1. **Read the notice and identify the tax year and the exact penalty code.** Confirm the year matches a year you actually failed to file. Assessment errors happen — for instance, a penalty charged for a year in which the LLC did not yet exist, or for a year already filed by fax where you hold the receipt.
2. **Pull your evidence.** Fax confirmation receipts, formation documents, bank records showing when the LLC was funded, correspondence with any adviser or formation agent.
...
1. Identify every tax year the LLC existed and had a reportable transaction — including the year it was formed and funded.
2. Prepare a separate complete package for each year, on the form revision applicable to that year.
3. Fax them together with one cover letter and one reasonable cause statement covering the full period, and keep the transmission receipt.
4. Respond to any existing penalty notice separately, referencing that fax by date.
