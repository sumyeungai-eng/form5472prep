---
title: "Form 5472: Customer Payments vs Owner Transactions"
description: "Customer revenue is not automatically reported on Form 5472. Learn how to separate invoices, owner funding, withdrawals, and foreign-source income."
date: 2026-08-25
updated: 2026-08-25
author: "Form5472 Prep"
tags: ["form-5472", "customer-payments", "foreign-source-income", "related-party"]
draft: false
---
...
Usually not when the customer is unrelated. The [IRS Form 5472 instructions](https://www.irs.gov/instructions/i5472) focus on reportable transactions with foreign or domestic related parties. An arm’s-length sale to an unrelated buyer is ordinary business activity.
...
| Bank entry | Form 5472? | Income-tax analysis? |
|---|---|---|
| Unrelated US client pays consulting invoice | Not automatically | Source generally follows where services were performed |
| Unrelated foreign buyer purchases inventory | Not automatically | Inventory sourcing and US business activity require review |
| Owner wires money marked “payment” without a real invoice | Usually owner funding | Contribution, loan, or other owner transaction |
| Owner’s foreign company pays the LLC for services | Yes, related-party transaction | Transfer pricing and income treatment also matter |
| LLC sends profits to owner | Yes, distribution | Owner-level tax treatment is separate |

## Does a US customer make service income US-source?

Not by itself. The IRS explains that [personal-service income is generally sourced where the services are performed](https://www.irs.gov/individuals/international-taxpayers/source-of-income-personal-service-income), regardless of where the contract was made, where payment arrived, or where the payer lives.
...
| Related-party ledger column | Purpose |
|---|---|
| Date and counterparty | Identifies the party and filing year |
| Relationship | Owner, owner company, family-controlled entity, or other |
| Transaction type | Contribution, distribution, loan, service, rent, royalty, reimbursement |
| Direction | Paid by LLC or received by LLC |
| Original currency and USD value | Supports gross Form 5472 totals |
| Source evidence | Bank line, invoice, agreement, or receipt |

One Form 5472 is generally prepared for each related party that had reportable transactions. The [multiple-related-parties guide](/blog/multiple-related-parties-form-5472) explains the separate-form rule.
