...
A new LLC can have a filing requirement because formation and funding are transactions. The [IRS Instructions for Form 5472](https://www.irs.gov/instructions/i5472) say Part V covers foreign-owned U.S. disregarded entities and includes amounts paid or received in connection with formation, dissolution, acquisition, and disposition, including contributions to and distributions from the entity.
...
1. List the formation date and the LLC's tax year.
2. Gather every organizer, state, registered-agent, address, EIN, and banking invoice.
3. Mark who paid each invoice: the owner personally, the LLC, or another related person.
4. Pull every owner-to-LLC and LLC-to-owner bank transfer.
5. Separate unrelated customer and vendor activity from owner and related-party activity.
6. Convert foreign-currency items into U.S. dollars using a documented method. The IRS instructions require amounts in U.S. dollars and an exchange-rate schedule for Part IV or Part VI reporting ([IRS Instructions for Form 5472](https://www.irs.gov/instructions/i5472)).
7. Prepare the Part V statement with dates, parties, transaction labels, and amounts.
...
1. The owner wires **$2,000** from a personal foreign bank account to the LLC's U.S. bank account.
2. The owner also pays **$850** of formation and setup costs personally before the LLC card is active.
3. The LLC earns **$0** of revenue.
4. The LLC makes no distribution and does not reimburse the owner before year-end.
...
The LLC needs an EIN to file. A foreign responsible party who lacks an SSN or ITIN can follow the [Form SS-4 instructions](https://www.irs.gov/instructions/iss4), which permit "foreign" or "N/A" on line 7b when the person is ineligible for an SSN or ITIN.

If the EIN process is still open, keep proof of the SS-4 submission and the facts needed for the return. The filing package still needs the entity identity to be complete, so do not treat a missing EIN as a reason to ignore the filing year. For the formation process, see [getting an EIN for a foreign-owned LLC without an SSN](/blog/ein-for-foreign-owned-llc-without-ssn).
